              ...
              <div class="col-3Two">
                <div class="newFooter">
                  <ul>
                    ...
                    <li><a href="https://github.com/N-Crofts/project_3" target="_blank" rel="noopener noreferrer"><i class="fa fa-github"></i></a></li>
                    <li><a href="https://www.linkedin.com/in/N-Crofts" target="_blank" rel="noopener noreferrer"><i class="fa fa-linkedin"></i></a></li>
                    <li><a href="https://twitter.com/NicholasCrofts" target="_blank" rel="noopener noreferrer"><i class="fa fa-twitter"></i></a></li>
                    <li><a href="http://www.instagram.com/nico_laos" target="_blank" rel="noopener noreferrer"><i class="fa fa-instagram"></i> </a></li>
                  </ul>
                </div>
              </div>
            </div>
